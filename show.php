...
<div id="main" class="auto">
	...
	<div class="wrapContent">
		<div class="left">
			<div class="face">
				<a target="_blank" <?php echo "href='member.php?id={$_COOKIE['sfk']['id']}'"  ?>>
	...
	<?php }?>
	<?php 
	$query="select sm.name,sr.member_id,sr.quote_id,sm.photo,sr.time,sr.id,sr.content from reply sr,member sm where sr.member_id=sm.id and sr.content_id={$_GET['id']} order by id asc {$page['limit']}";
