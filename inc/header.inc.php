...
<body>
	<div class="header_wrap">
		<div id="header" class="auto">
			<div class="logo">遇见社区</div>
			<div class="nav">
				<a class="hover" href="index.php">首页</a>
				<a href="admin/index.php" target="_blank">后台</a> 
			</div>
			<div class="serarch">
				<form action="search.php" method="get">
					<input class="keyword" type="text" name="keyword" value="<?php if(isset($_GET['keyword']))echo $_GET['keyword']?>" placeholder="搜索帖子" />
