...
if(isset($_POST['submit'])){
	...
	$query="insert into member(name,pw,register_time,photo,last_time) values('{$_POST['name']}',md5('{$_POST['pw']}'),now(),'',now())";
	execute($link,$query);
...
<?php include 'inc/header.inc.php'?>
	<div id="register" class="auto">
		...
		<form method="post">
			...
			<input class="btn" name="submit" type="submit" value="注册" />
		</form>
	</div>
